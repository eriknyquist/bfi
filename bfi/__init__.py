...
def execute(opcodes, input_data=None, time_limit=None, tape_size=30000,
    ...
    :param write_byte: callback to implement custom write behaviour, should accept \
        one argument which is the byte to write as an integer, and return nothing.\
        Overrides the 'buffer_output' argument.
    :param read_byte: callback to implement custom read behaviour, should accept \
        no arguments return the read byte as an integer. Overrides the 'input_data' \
        argument.
    """
